...
greeting = """
Выбери направление в списке, чтобы узнать о нём больше!

Обрати внимание, что для выбора нескольких направлений заявки нужно подавать ПО ОТДЕЛЬНОСТИ (в будущем это будет исправлено 😊).
"""
